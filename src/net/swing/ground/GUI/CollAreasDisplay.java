...
/**
 * ATTENTION: This class is outdated. Due to incompatibility with new collision
 * areas system and lack of need to use it anywhere it was commented.
 */

public class CollAreasDisplay // extends Graphics
{
	
	// private RenderTexture render = new RenderTexture();
	// private float width, height, p;
	// int r, c, highl_x = 1, highl_y = 1;
	// private int[] things;
	...
	// */
	// public CollAreasDisplay(Rectanglef area, int rows, int collumns, float
	// proportion)
	// {
	// this.set(area);
	// r = rows;
	...
	// * - proportion between cell and thing in that cell
	// */
	// public CollAreasDisplay(float x, float y, int rows, int collumns, float
	// rowHeight, float collWidth, float proportion)
	// {
	// r = rows;
	// c = collumns;
	// width = collWidth;
	...
	// public void resize(float x, float y, int rows, int collumns, float
	// rowHeight, float collWidth, float proportion)
	// {
	// r = rows;
	// c = collumns;
	...
	// }
	//
	// /** Puts full set of blocks of collision areas */
	// public void setThings()
	// {
	// setThings(CollAreas.getAreas());
	// }
	//
	// public void setThings(CollArea[] ids)
	// {
	// for (int i = 0; i < ids.length && i < things.length; i++)
	// {
	// things[i] = ids[i].ID;
	// }
	// }
	...
	// public int getSelectedThingID()
	// {
	// return things[highl_x - 1 + highl_y * c - c];
	// }
	//
	// public CollArea getSelectedThing()
	// {
	// return CollAreas.getByID(getSelectedThingID());
	// }
	//
	// public void put(CollArea thing, float x, float y)
	// {
	// if (isPointInside(x, y))
	// {
	// putAt(thing, (int) Math.ceil((double) (x - getX()) / width), (int)
	// Math.ceil((double) (y - getY()) / height));
	// }
	// }
	//
	...
	// if (isPointInside(x, y))
	// {
	// putAt(thingID, (int) Math.ceil((double) (x - getX()) / width), (int)
	// Math.ceil((double) (y - getY()) / height));
	// }
	// }
	//
	...
	// }
	//
	// public void putAt(CollArea thing, int x, int y)
	// {
	// try
	// {
	// things[x - 1 + y * c - c] = thing.ID;
	// }
	// catch (ArrayIndexOutOfBoundsException e)
	// {
	//
	...
	// private CollArea pickedThing = CollAreas.area0;
	//
	// public CollArea getPickedThing()
	// {
	// return pickedThing;
	// }
	//
	...
	// {
	// isMouseInside = isPointInside(Controls.mouseX, Controls.mouseY);
	// render.renderColor(pickedThing.color, Controls.mouseX, Controls.mouseY,
	// p, p);
	//
	// thingDropped = 0;
	// if (isMouseInside())
	...
	// if (isMouseInside())
	// {
	// putAt(pickedThing, highl_x, highl_y);
	// }
	// else
	// {
	// thingDropped = pickedThing.ID;
	// }
	// pickedThing = CollAreas.area0;
	// }
	// }
	// render();
	//
	...
	// {
	// render.renderColor(CollAreas.getByID(things[i - 1]).color, paddingX + x,
	// paddingY + y, p, p);
	// if (i % c == 0)
	// {
	// x = getX();

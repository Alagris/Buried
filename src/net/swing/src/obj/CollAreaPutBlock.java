...
public final class CollAreaPutBlock extends CollArea
{
	 ...
	 */
	public CollAreaPutBlock(String a)
	{
		super(a);
	...
	public void run(Entity source, boolean wasAreaChanged)
	{
		if (wasAreaChanged)
		{
			...
			{
				LunarEngine2DMainClass.getRoom().getFloor().putBlock(ids[i], locations[i]);
			}
		}
	}
